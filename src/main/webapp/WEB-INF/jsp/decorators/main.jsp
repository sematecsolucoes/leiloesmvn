...
<title>Sematec Ensino e Inovação</title>
...
<body>
    ...
    <div id="topmenu">
        ...
        <div id="wrapper">
            ...
            <div id="sidebar">
  				<ul>
                	<li><h3><a href="#" class="house">Sematec Online</a></h3>
                        <ul>
                        	<li><a href="http://www.sematec.com.br/online" class="report">Veja nossos cursos!</a></li>
                        </ul>
                    </li>
                </ul>
          </div>
